...
3. Upload:
   ...
   - Bloomberg Custom_Run_Filter workbook (proprietary analytics — not a mapping file)
...
3. Never recompute proprietary metrics from the Bloomberg Custom_Run_Filter workbook.
